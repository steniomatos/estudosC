...
/**
 * @steniomatos
 * Um(a) procedimento/função que determine, e apresente na tela, a interseção de A e
de B. Armazene a interseção dos dois conjuntos no arquivo original.
*/
...
void calcularIntersecao(int conjuntoA[], int tamanhoA, int conjuntoB[], int tamanhoB) {
...
int main() {
    ...
    calcularIntersecao(conjuntoA, tamanhoA, conjuntoB, tamanhoB);
